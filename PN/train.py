from prototypical_network import *
from experiment_builder_prototypical import ExperimentBuilder_CIFAR
...
# epochs = --0-200
logs_path = "PN_outputs/"

fce = False
if train_on_img:
    channels = 3    
    experiment_name = logs_path + "PN_cifar_{}_{}".format(samples_per_class, classes_per_set)
    ...
    one_shot_cifar, losses, c_error_opt_op, init = experiment.build_experiment(batch_size,\
        classes_per_set, samples_per_class, queries_per_class, channels, fce)
else:
    channels = 1 
    experiment_name = logs_path + "PN_omniglot_{}_{}".format(samples_per_class, classes_per_set)
